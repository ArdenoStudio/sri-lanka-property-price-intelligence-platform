      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-accent/20 border border-accent/30 flex items-center justify-center">
            <img src="/favicon.svg" alt="PropertyLK" className="w-5 h-5" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <a
              ...
              className="group relative flex items-center text-text-secondary hover:text-accent-light transition-colors"
              aria-label="View on GitHub"
            >
              <span className="absolute -inset-2 rounded-full bg-accent/10 opacity-0 blur-md group-hover:opacity-100 transition-opacity duration-300" />
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="relative z-10 transition-transform duration-200 group-hover:scale-110">
