    ...
    <div className="flex items-center gap-2">
      ...
      >
        <AnimatePresence mode="wait" initial={false}>
          {copied ? (
            <motion.span key="check" {...fb} className="flex items-center gap-1.5 text-white">
      ...
      <button
        onClick={whatsapp}
        className="flex items-center justify-center w-8 h-8 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] border border-white/[0.08] hover:border-white/20 transition-all cursor-pointer"
        title="Share on WhatsApp"
      >
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-[#525252] hover:fill-white" style={{ transition: 'fill 0.15s' }}>
      ...
      {hasNativeShare && (
        <button
          onClick={nativeShare}
          className="flex items-center justify-center w-8 h-8 rounded-xl bg-white/[0.06] hover:bg-[#f5f5f5]/[0.15] border border-white/[0.08] hover:border-[#f5f5f5]/30 transition-all cursor-pointer"
          title="Share"
        >
